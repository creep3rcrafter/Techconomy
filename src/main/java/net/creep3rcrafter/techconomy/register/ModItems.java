...
import net.creep3rcrafter.techconomy.items.MineCoinSackItem;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> MINECOIN_SACK = ITEMS.register("minecoin_sack", () -> new MineCoinSackItem(new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS), 64));
}
